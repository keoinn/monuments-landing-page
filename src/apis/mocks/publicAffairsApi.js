...
const mockPublicAffairsCategories = [
  {
    title: '法規政策',
 ...
 * @returns {Promise<Object>} 包含 quickStats、publicAffairsCategories、recentDocuments 和 contactInfo 的物件
 */
export async function fetchPublicAffairsData () {
  ...
  return Promise.resolve({
    ...
    publicAffairsCategories: mockPublicAffairsCategories,
